...
class Interconnection:
    """
        ...
        Attributes:
            ...
            _historical_powers (pd Series): stores incoming power values by time step.
            _simulated_powers (pd Series): stores outgoing power values by time step.
    """
    ...
    def __init__(self, zone_from, zone_to, power_rating: float, historical_power_flows: pd.Series):
        ...
        self._historical_powers = historical_power_flows
        self._current_power = 0
        self._simulated_powers = pd.Series()
